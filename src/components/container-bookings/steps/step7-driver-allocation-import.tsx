...
interface Step7DriverAllocationImportProps {
  bookingId: number
...
export function Step7DriverAllocationImport({
  bookingId,
  formData,
  routingData,
  step3Data,
  onUpdate,
  errors,
}: Step7DriverAllocationImportProps) {
  ...
  return (
    <div className="space-y-6">
      <div className="text-sm text-muted-foreground mb-4">
        <p>Import driver allocation order: Full Container → Empty Container</p>
        <p className="mt-1">
