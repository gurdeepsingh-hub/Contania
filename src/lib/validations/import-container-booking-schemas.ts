...
export const step2Schema = z
  .object({
    ...
    containerQuantities: z.record(z.string(), z.number().min(1)),
  })
  .refine(
    (data) => {
        ...
        productLines: z
          .array(
            z.object({
              ...
              recievedWeight: numberOrUndefined,
              weightPerHU: numberOrUndefined,
              expectedCubicPerHU: numberOrUndefined,
              recievedCubicPerHU: numberOrUndefined,
              palletSpaces: numberOrUndefined,
          ...
          .optional(),
        stage: z.enum(['expected', 'received', 'put_away']).optional(),
      }),
    )
    .optional(),
})
