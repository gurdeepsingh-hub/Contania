...
import { canManageRoles, isAdmin } from '@/lib/permissions'
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok && data.success) {
        ...
        setSuccess(true)
        setTimeout(() => {
          router.push('/dashboard/settings/company-settings')
        }, 2000)
      } else {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <div className="flex items-center gap-4">
        <Button variant="ghost" size="icon" onClick={() => router.push('/dashboard/settings/company-settings')}>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="flex gap-4 mt-6">
          <Button
            type="button"
            variant="outline"
            onClick={() => router.push('/dashboard/settings/company-settings')}
            disabled={saving}
          >
            Cancel
          </Button>
