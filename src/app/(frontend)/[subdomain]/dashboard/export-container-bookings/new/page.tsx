...
export default function NewExportContainerBookingPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold">New Export Container Booking</h1>
          <p className="text-muted-foreground">Create a new export container booking</p>
        </div>
      </div>

      <MultistepExportContainerBookingForm onSave={handleSave} onCancel={handleCancel} />
    </div>
  )
}
