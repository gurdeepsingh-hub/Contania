...
export const DelayPoints: CollectionConfig = {
  slug: 'delay-points',
  admin: {
    useAsTitle: 'name',
  },
  ...
  fields: [
    {
      ...
      required: true,
      admin: {
        description: 'Links delay point to their company (tenant)',
      },
    },
    {
      name: 'name',
      ...
      required: true,
      admin: {
        description: 'Name of delay point',
      },
    },
    {
      name: 'email',
      type: 'email',
      admin: {
        description: 'Delay point email address',
      },
    },
    {
      name: 'contactName',
