...
export const EmptyParks: CollectionConfig = {
  slug: 'empty-parks',
  admin: {
    useAsTitle: 'name',
  },
  ...
  fields: [
    {
      ...
      required: true,
      admin: {
        description: 'Links empty park to their company (tenant)',
      },
    },
    {
      name: 'name',
      ...
      required: true,
      admin: {
        description: 'Name of empty park',
      },
    },
    {
      name: 'email',
      type: 'email',
      admin: {
        description: 'Empty park email address',
      },
    },
    {
      name: 'contactName',
