...
export const HandlingUnits: CollectionConfig = {
  slug: 'handling-units',
  admin: {
    useAsTitle: 'name',
  },
  ...
  fields: [
    {
      ...
      required: true,
      admin: {
        description: 'Links handling unit to their company (tenant)',
      },
    },
    {
      name: 'abbreviation',
      type: 'text',
      admin: {
        description: 'Short code for the unit (e.g. CTN for carton)',
      },
    },
    {
      name: 'name',
      ...
      required: true,
      admin: {
        description: 'Full name of handling unit (e.g. Carton, Bottle, Drum)',
      },
    },
  ],
  timestamps: true,
