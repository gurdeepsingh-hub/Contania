...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_import_container_bookings_status" AS ENUM('draft', 'confirmed', 'expecting', 'partially_received', 'received', 'partially_put_away', 'put_away', 'completed', 'cancelled');
  CREATE TYPE "public"."enum_export_container_bookings_status" AS ENUM('draft', 'confirmed', 'allocated', 'partially_picked', 'picked', 'ready_to_dispatch', 'dispatched', 'completed', 'cancelled');
  CREATE TYPE "public"."enum_container_details_status" AS ENUM('expecting', 'received', 'put_away', 'allocated', 'picked_up', 'dispatched');
  ...
  CREATE TABLE "put_away_stock" (
  	...
  	"inbound_inventory_id_id" integer,
  	"inbound_product_line_id_id" integer,
  	"container_detail_id_id" integer,
  	"container_stock_allocation_id_id" integer,
  ...
  CREATE TABLE "export_container_bookings" (
  	...
  	"empty_routing_shipping_line_id_id" integer,
  	"empty_routing_pickup_location_id_id" integer,
  	"empty_routing_pickup_location_collection" varchar,
  	"empty_routing_pickup_date" timestamp(3) with time zone,
  	"empty_routing_via_locations_collections" jsonb,
  	"empty_routing_dropoff_location_collection" varchar,
  	"empty_routing_dropoff_date" timestamp(3) with time zone,
  ...
  CREATE TABLE "container_details" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"status" "enum_container_details_status" DEFAULT 'expecting' NOT NULL,
  	"warehouse_id_id" integer NOT NULL,
  ...
  ALTER TABLE "put_away_stock" ADD CONSTRAINT "put_away_stock_container_detail_id_id_container_details_id_fk" FOREIGN KEY ("container_detail_id_id") REFERENCES "public"."container_details"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "put_away_stock" ADD CONSTRAINT "put_away_stock_container_stock_allocation_id_id_container_stock_allocations_id_fk" FOREIGN KEY ("container_stock_allocation_id_id") REFERENCES "public"."container_stock_allocations"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "pickup_stock" ADD CONSTRAINT "pickup_stock_container_detail_id_id_container_details_id_fk" FOREIGN KEY ("container_detail_id_id") REFERENCES "public"."container_details"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "pickup_stock" ADD CONSTRAINT "pickup_stock_container_stock_allocation_id_id_container_stock_allocations_id_fk" FOREIGN KEY ("container_stock_allocation_id_id") REFERENCES "public"."container_stock_allocations"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "container_details" ADD CONSTRAINT "container_details_warehouse_id_id_warehouses_id_fk" FOREIGN KEY ("warehouse_id_id") REFERENCES "public"."warehouses"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "put_away_stock_container_detail_id_idx" ON "put_away_stock" USING btree ("container_detail_id_id");
  CREATE INDEX "put_away_stock_container_stock_allocation_id_idx" ON "put_away_stock" USING btree ("container_stock_allocation_id_id");
  ...
  CREATE INDEX "pickup_stock_container_detail_id_idx" ON "pickup_stock" USING btree ("container_detail_id_id");
  CREATE INDEX "pickup_stock_container_stock_allocation_id_idx" ON "pickup_stock" USING btree ("container_stock_allocation_id_id");
  ...
  CREATE INDEX "container_details_warehouse_id_idx" ON "container_details" USING btree ("warehouse_id_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_container_details_status";
